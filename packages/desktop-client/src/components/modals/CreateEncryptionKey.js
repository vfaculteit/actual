...
export default function CreateEncryptionKey({
  ...
  return (
    <Modal
      {...modalProps}
      style={{ width: 600 }}
      title={isRecreating ? t('Generate new key') : t('Enable encryption')}
      ...
      {() => (
        <>
          {!isRecreating ? (
            <>
              <P style={{ marginTop: 5 }}>
                <Trans i18nKey="enableEndToEndEncryptionCreateKeyExplanation">
              ...
              <P>
                <ul {...css({ marginTop: 0, '& li': { marginBottom: 8 } })}>
                  <Trans i18nKey="keyCreationExplanation">
                    <li>
            ...
            <Trans i18nKey="keyGenerationExplanation">
              <P style={{ marginTop: 5 }}>
